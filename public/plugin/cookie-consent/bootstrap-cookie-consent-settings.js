...
function BootstrapCookieConsentSettings(props) {
    ...
    this.props = {
        ...
        contentURL: "plugin/cookie-consent/cookie-consent-content", // this folder must contain the language-files in the needed languages (`[lang].js`)
        ...
        lang: "fr",//navigator.language, // the language, in which the modal is shown
